...
- After SerpApi is verified with a real SerpApi.com key, persist that provider-test state locally so older 401 failures stay stale/collapsed after refresh or Tavily tests; do not add Serper.
