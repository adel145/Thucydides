...
import { createSourceRecord } from "@/app/sources/actions";
    ...
    <div className="grid gap-6">
      <GlassCard>
        ...
        <p className="mt-4 max-w-3xl text-sm leading-6 text-ink-200">
          Track CVs, LinkedIn text, GitHub projects, certificates, academic documents, and job-search notes locally. No upload parsing yet.
        </p>
      </GlassCard>
